...
+ [Installazione](#installazione)
    + [Clonazione della Repository](#clonazione_della_repository)
    + [Installazione dell'Applicazione Web](#installazione_dell'applicazione_web)
    + [Installazione del Modulo IA](#installazione_del_modulo_ia)
    + [Installazione del Database](#installazione_del_database)
+ [Test](#test)
+ [Altro](#altro)
